...
puts "Welcome to the Secret Number game! This game was created by Alex K."
...
puts "Hi #{create_player.player_name}! You will need to guess a number between 1 and 10. You will have three tries."
